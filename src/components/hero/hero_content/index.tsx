    ...
    <div className="md:w-1/2 mb-10 md:mb-0 flex flex-col justify-center items-start text-left max-w-xl mx-auto md:mx-0">
      ...
      <div className="flex gap-4 w-full animate-slide-up">
        <button
          ...
          className="flex items-center gap-2 bg-gradient-to-tr from-[var(--primary)] via-[var(--amber)] to-[var(--burnt-orange)] text-white px-8 py-4 rounded-xl font-bold text-lg shadow-[var(--primary-glow)] hover:scale-105 transition-all duration-200 hover:ring-2 hover:ring-[var(--amber)] group"
        >
