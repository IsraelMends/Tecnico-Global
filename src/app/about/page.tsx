        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-black/90 leading-relaxed animate-slide-up">
              ...
              regulares e por competência, pensados para quem busca crescimento
              profissional de forma prática, rápida e reconhecida.
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Nosso propósito é simples e poderoso: levar ensino de qualidade
                a quem deseja crescer, com metodologias modernas, acessíveis e
                que valorizam a prática. Enquanto nossos alunos conquistam
                qualificação e oportunidades reais, você encontra em nós uma
                parceira comprometida em formar profissionais preparados para os
                desafios do futuro.
              </p>
